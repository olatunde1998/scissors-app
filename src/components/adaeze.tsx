const Adaeze = () => {
  return (
    <div
      id="vission&mission"
      className="max-w-7xl w-[100%] lg:w-[80%] mx-[auto] py-[50px]">
          <div className=" mt-[20px] p-4 lg:flex justify-between">
           
            <div className="">
            
                
                <h3 className="font-bold text-[24px] lg:text-[2rem] mb-[15px] border-l-4 border-blue-400">
                    {" "}
                    Why Choose <span className="text-[#053AAC]"> Scissors </span>
                </h3>
              
                
                <p className=" max-w-7xl w-[85%] text-[12px] lg:text-[15px]">Scissors is the hub of everything that has to do with your link management. We shorten your URLs, allow you creating custom ones for your personal, business, event usage. Our swift QR code creation, management and usage tracking with advance analytics for all of these is second to none. </p>
            </div>
